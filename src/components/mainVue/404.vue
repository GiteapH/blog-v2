        ...
        <section class="wrapper">
            ...
            <div class="container">
                ...
                <div id="scene" class="scene" data-hover-only="false">
                    ...
                    <p class="p404" data-depth="0.50">{{ code }}</p>
                    <p class="p404" data-depth="0.10">{{code}}</p>

                </div>

                <div class="text">
                    <article>
                        <p style="color:darkorange;font-size:25px;font-weight:500">访问异常： <br>{{ describe }}</p>

                        <button onclick="javascript:location.href='/'" style="margin-bottom:25px;">返回首页</button>
                        <button onclick="javascript:window.history.go(-1) ">返回上级</button>
                    </article>
                </div>
            </div>
        </section>
...
export default defineComponent({
    ...
    mounted() {
        ...
        let description = this.$route.params.describe
        if(code) this.code = code
        if(description) this.describe = description
    },
})
</script>
<style>
